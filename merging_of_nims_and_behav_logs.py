...
path_to_data_to_org = './all_subj'

df = pd.read_csv('.output_files/for_bids_cleaned.csv', dtype=str)
...
newcols = ['exam', 'behav', 'subject_x',
           'run1', 'run_type_x', 'run2', 'run_type_y']
all = all[newcols]
all.to_csv('./output_files/new.csv', index=False)
